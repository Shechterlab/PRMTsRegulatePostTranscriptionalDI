...
dTrack1 <- DataTrack(range = bwFile1, genome = "hg19", type = "l", 
                     chromosome = "chr1", name = "bigWig", ylim= c(0,30000))
...
txTr <- GeneRegionTrack(TxDb.Hsapiens.UCSC.hg19.knownGene, chromosome = 'chr1', start = 173832227, end = 173837439)

#plotTracks(dTrack2, chromsome = "chr5", from = 179032266, to = 179052362)
#plotTracks(bmt)
#plotTracks(txTr)

pdf('2d_PRMTi_GAS5.RPKM.pdf', height = 10, width = 30)
plotTracks(c(txTr, dTrack1, dTrack2, dTrack3), chromsome = "chr1", from = 173832227, to = 173837439)
dev.off()
