...
wilcox.test(df[df$variable == 'DMSO',]$value, df[df$variable == 'GSK591',]$value, paired = TRUE, alternative = "less")
wilcox.test(df[df$variable == 'DMSO',]$value, df[df$variable == 'MS023',]$value, paired = TRUE, alternative = "greater")
wilcox.test(df[df$variable == 'GSK591',]$value, df[df$variable == 'MS023',]$value,, paired = TRUE, alternative = "greater")
