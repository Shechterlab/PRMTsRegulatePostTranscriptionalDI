...
data <- read.table('SKaTER/Sequencing_Analysis/results/MS023rep1_MS023rep2_fractionCleavageBeforeSplicing.txt', header = T, sep = '\t')
...
introns <- read.table('SKaTER/Sequencing_Analysis/database/skater_optimize_v0_5_MS023rep1_database_sorted_skater_optimize_v0_5_MS023rep2_database_sorted_intronPosition.txt', header = T, sep = '\t')
...
#pdf('R_figures/MS023_SKaTER_probabilityofcleavage_vs_intronPosition_ecdf.pdf', height = 10, width = 10)
